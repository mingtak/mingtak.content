...
tagline = u'提供linux/python/plone/相關技術資訊'

# Change this to the description of your blog
description = u'提供linux/python/plone/相關技術資訊'

# Change this to your name
author = u'銘啟科技'

# Change this to your copyright string
copyright = '2010-2014, ' + author

# Change this to your blog root URL (required for RSS feed)
website = u'http://127.0.0.1/blog/html/'
...
html_sidebars = {
    "**": ["googlead.html", "localtoc.html", "recent.html", "searchbox.html", ]
}
